                    ...
                    <div class="all_rooms">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single_room_item">
                                ...
                                <div class="room_title">
                                    <h2>Start From $<?php pullroomprice('Orchid', 'Cheap', $_SESSION['mapaddr'], $conn) ?> / Night</h2>
									
									
									
									<?php 
										$ch = runquery('Orchid', 'Cheap', $_SESSION['mapaddr'], $conn);
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single_room_item">
                                ...
                                <div class="room_title">
                                    <h2>Start From $<?php pullroomprice('Orchid', 'Standard', $_SESSION['mapaddr'], $conn) ?> / Night</h2>
									
									
									
									<?php 
										$ch = runquery('Orchid', 'Standard', $_SESSION['mapaddr'], $conn);
                        ...
                        <div class="col-md-4 col-sm-6 col-md-offset-0 col-sm-offset-3">
                            <div class="single_room_item">
                                ...
                                <div class="room_title">
                                    <h2>Start From $<?php pullroomprice('Orchid', 'Deluxe', $_SESSION['mapaddr'], $conn) ?> / Night</h2>
									
									
									
									<?php 
										$ch = runquery('Orchid', 'Deluxe', $_SESSION['mapaddr'], $conn);
		...
		<script>
		 ...
		 function fromaccomtoreser(rt){
			 ...
			 $.post('setsessionfrobooking.php',{roomtype:rt}, function(data){
				 window.open("Reservation1.php", "_self");
			 });
