                    ...
                    <div class="main_header">
                        <div class="row">
                            <div class="col-md-3 col-sm-2">
                                <div class="logo">
                                    <a href="index2.php"><img src="img/tuliplogo.png" alt="Site Logo" style="width:104px;height:72px;"></a>                     
                                </div>
                            </div>
		 ...
		 <select id="map_id" name='mappair' onChange="addresschange()">
			...
			<?php
				...
				$query = "select * from hotel_master 
						where chain = 'Tulip' and roomtype='Standard' ";
      ...
      <span class="sr-only">Next</span>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section_heading" style="text-align: center;">
                            <img src="img/tuliplogo.png" style="width:270px;height:168px;">
                            <h2>Welcome to Tulip Hotel, your friendly and hospitable hotel brand</h2>
                ...
                <div class="row">
                    <div class="container intro" >
                        ...
                        <p>Located in idyllic Harrisonburg, Virginia in the gorgeous Shenandoah Valley, Tulip Hotel blends a sophisticated style with relaxing comfort. Featuring well-appointed rooms and suites with mountain and downtown views, as well as compelling dining, facilities and meeting space, this Tulip hotel is an elegant and inspiring choice. Regarded as a premier destination for Virginia business and leisure travel, Hotel Tulip provides superior accommodations, event spaces, and staff services, perfect for a quick visit or long-term stay. Guests will be pleased to find the Montpelier Restaurant & Bar located on the property, as well as a fitness center, business center, indoor pool, and guest laundry—the essentials for feeling your best at all times.</p>
                            ...
                            <nav class="footer_menu">
                                <ul>
                                   ...
                                   <li><a href="index2.php">Home</a></li>
                                            ...
                                            <li><a href="Facilities&Services2.php">Facilities</a></li>
                                            <li><a href="Location&ContactUs2.php">ContactUs</a></li>
                                            <li><a href="Reservation2.php">Reservation</a></li> 
