                    ...
                    <div class="all_rooms">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single_room_item">
                                ...
                                <div class="room_title">
                                    <h2>Start From $<?php pullroomprice('Lotus', 'Cheap', $_SESSION['mapaddr'], $conn) ?> / Night</h2>
									 
									
									<?php 
										$ch = runquery('Lotus', 'Cheap', $_SESSION['mapaddr'], $conn);
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single_room_item">
                                ...
                                <div class="room_title">
                                    <h2>Start From $<?php pullroomprice('Lotus', 'Standard', $_SESSION['mapaddr'], $conn) ?> / Night</h2>
									
									<?php 
										$ch = runquery('Lotus', 'Standard', $_SESSION['mapaddr'], $conn);
                        ...
                        <div class="col-md-4 col-sm-6 col-md-offset-0 col-sm-offset-3">
                            <div class="single_room_item">
                                ...
                                <div class="room_title">
                                    <h2>Start From $<?php pullroomprice('Lotus', 'Deluxe', $_SESSION['mapaddr'], $conn) ?> / Night</h2>
									
									<?php 
										$ch = runquery('Lotus', 'Deluxe', $_SESSION['mapaddr'], $conn);
