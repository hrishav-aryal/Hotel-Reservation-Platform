...
<html lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="http://csci370finalproject.atwebpages.com/style.css">
        ...
        <title>Add Lotus Hotel Form</title>
   ...
   <div class="container" style="background-color: white;padding:0;">
         ...
         <form method="post" action="addlotushotel.php">
...
if(count($errors)==0){
    ...
    VALUES ('$xCod','$yCod',CONCAT('(',$xCod,',', $yCod, ')'),'Lotus','Cheap','$BadRate','$NumberCheap'),
    ('$xCod','$yCod',CONCAT('(',$xCod,',', $yCod, ')'),'Lotus','Standard','$MediumRate','$NumberStandard'),
    ('$xCod','$yCod',CONCAT('(',$xCod,',', $yCod, ')'),'Lotus','Deluxe','$GoodRate','$NumberDeluxe')";
...
<?php include('adminerrors.php');?>
             <div class="button">
                <button type="submit" name="addlotus" class="btn">Add Lotus Hotel</button>
             </div>
         </form>
     </div>
         </div>
