...
<html lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="http://csci370finalproject.atwebpages.com/style.css">
        ...
        <title>Add Orchid Hotel Form</title>
                    ...
                    <div class="main_header">
                        <div class="row">
                            <div class="col-md-3 col-sm-2">
                                <div class="logo">
                                <a href="index2.html"><img src="img/Orchidlogo.png" alt="Site Logo" style="width:100px;height:72px;"></a>                     
                                </div>
                            </div>
                                ...
                                <nav class="main_menu">
                                    <div class="navbar-collapse collapse"> 
                                        <ul class="nav navbar-nav navbar-right">
                                            <li><a href="orchidadminpage.php">Home</a></li>
											<li><a href="addorchidhotel.php">Add Hotel</a></li>
   ...
   <div class="container" style="background-color: white;padding:0;">
         ...
         <form method="post" action="addorchidhotel.php">
...
if(count($errors)==0){
    ...
    VALUES ('$xCod','$yCod',CONCAT('(',$xCod,',', $yCod, ')'),'Orchid','Cheap','$BadRate','$NumberCheap'),
    ('$xCod','$yCod',CONCAT('(',$xCod,',', $yCod, ')'),'Orchid','Standard','$MediumRate','$NumberStandard'),
    ('$xCod','$yCod',CONCAT('(',$xCod,',', $yCod, ')'),'Orchid','Deluxe','$GoodRate','$NumberDeluxe')";
...
<div class="button">
                <button type="submit" name="addorchid" class="btn">Add Orchid Hotel</button>
             </div>
         </form>
     </div>
         </div>
