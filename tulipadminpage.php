...
<html lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="http://csci370finalproject.atwebpages.com/style.css">
        ...
        <title>Tulip Administrator Home </title>
                                ...
                                <nav class="main_menu">
                                    <div class="navbar-collapse collapse"> 
                                        <ul class="nav navbar-nav navbar-right">
                                            <li><a href="tulipadminpage.php">Home</a></li>
											<li><a href="addtuliphotel.php">Add Hotel</a></li>
   ...
   <div class="container" style="background-color: white;padding:0;">
                ...
                <div class="back_nav">
                    ...
                    <div class="col-sm-7">
                        <ul class="text_a_r" style="text-align: right;">
                            ...
                            <li><a href="http://csci370finalproject.atwebpages.com/addtuliphotel.php">Add Hotel</a></li>
                        </ul>
                    </div>
                </div>
            </div>
		...
		<div id='recordscontainer'>
         <h3> Tulip Hotel Adminstrator </h3><br>
         ...
         <table>
            ...
            $sql = "SELECT *
            FROM reservation_master WHERE checkindate > '$_SESSION[currentdate]' and chain = 'Tulip'";
         ...
         <tr>
           <th>ID</th>
            ...
            $sql = "SELECT *
            FROM reservation_master WHERE checkindate <= '$_SESSION[currentdate]' and checkoutdate >= $_SESSION[currentdate] and chain = 'Tulip'";
            $result = $conn->query($sql);
            if ($result->num_rows > 0) {
            // output data of each row
            while($row = $result->fetch_assoc()) {
