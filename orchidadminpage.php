...
<html lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="http://csci370finalproject.atwebpages.com/style.css">
        ...
        <title>Orchid Administrator Home </title>
   ...
   <div class="container" style="background-color: white;padding:0;">
		...
		<div id='recordscontainer'>
         <h3> Orchid Hotel Adminstrator </h3><br>
         ...
         <table>
            ...
            $sql = "SELECT *
            FROM reservation_master WHERE checkindate > '$_SESSION[currentdate]' and chain = 'Orchid'";
			...
			<div id='recordscontainer'>
            <br>
            <h4> <b> Currently Checked In Records:</b>  </h4><br>
         <table>
         <tr>
            <th>ID</th>
					<th>Guest</th>
            ...
            $sql = "SELECT *
            FROM reservation_master WHERE checkindate <= '$_SESSION[currentdate]' and checkoutdate >= $_SESSION[currentdate] and chain = 'Orchid'";
            $result = $conn->query($sql);
            if ($result->num_rows > 0) {
            // output data of each row
            while($row = $result->fetch_assoc()) {
