...
.error {
                                    ...
                                    <div class="navbar-collapse collapse"> 
                                        <ul class="nav navbar-nav navbar-right">
                                           <li><a href="index.php">Main Page</a></li>
                                            ...
                                            <li><a href="Accommodation1.php">Accomodation</a></li>
                                            <li><a href="Location&ContactUs1.php">ContactUs</a></li>
											<li><a href="Reservation1.php">Reservation</a></li>
                                            <li><a href="orchidadminlogin.php">Administrator</a></li>
   ...
   <div class="container" style="background-color: white;padding:0;">
         ...
         <div class="header">
        <h2>Orchid Admin Login</h2>
    </div>

    <form method="post" action="orchidadminlogin.php">
