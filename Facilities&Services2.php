                ...
                <div class="row">
                    <div>
                        <div class="col-md-4 col-sm-6">
                            <div class="col-xs-12 fix_p_r">
                                  <div class="faci-item card" style="padding:10px;">
                                    ...
                                    <img src="img/safty.jpg" alt="" style="width:100%;height:250px;padding-bottom:10px;">
                                        
                                        <p>With an extensive security system and 24-hour patrols, your safety is our priority.
                                        </p>
                      ...
                      <div class="col-md-4 col-sm-6">
                            <div class="col-xs-12 fix_p_r">
                                  <div class="faci-item card" style="padding:10px;">
                                    <h3>PARKING & TAXI SERVICES</h3>
                                    <img src="img/parking.jpg" alt="" style="width:100%;height:250px;padding-bottom:10px;">
                                        
                                        <p>Getting around is hassle-free parking, valet and limousine services available at your convenience </p>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="col-xs-12 fix_p_r">
                                  <div class="faci-item card" style="padding:10px;">
                                    <h3>OUTDOOR POOL</h3>
                                    <img src="img/pool.jpg" alt="" style="width:100%;height:250px;padding-bottom:10px;">
                                        
                                        <p>Enjoy a leisurely lap, soak in the tropical sun at our outdoor pool or relax at our shaded deck area.</p>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="col-xs-12 fix_p_r">
                                  <div class="faci-item card" style="padding:10px;">
                                    ...
                                    <img src="img/business-center.jpg" alt="" style="width:100%;height:250px;padding-bottom:10px;">
                                        
                                        <p>Work effortlessly in a dedicated business area with full office facilities and secretarial support.</p>
                            ...
                            <div class="col-xs-12 fix_p_r">
                                  <div class="faci-item card" style="padding:10px;">
                                    ...
                                    <img src="img/meeting.jpg" alt="" style="width:100%;height:250px;padding-bottom:10px;">
                                        ...
                                        <p>Lotus Hotel is fully equipped with state-of-the-art facilities to handle business conferences, meetings and weddings.</p>
